...
export class ChartBehavior {
  ...
  init() {
    ...
    if (this.data) {
      ...
      drawReportArea(this.context, getCompanyReportArray(this.data), getCompanyReportArray(this.data), this.width, this.height);
    }
  ...
  converterData() {
    ...
    console.log('personalReport', this.personalReport);
  ...
  barBusiness3() {
    if (this.context) {
      ...
      this.context.fill();
      this.context.fillRect(55, this.height - smallRadio(this.height), 15, 5);
      this.context.fill();
  ...
  barBusiness2() {
    if (this.context) {
      ...
      this.context.fill();
      this.context.fillRect(this.width - 75, this.height - smallRadio(this.height), 15, 5);
      this.context.fill();
